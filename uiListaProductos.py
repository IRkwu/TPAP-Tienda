...
class uiListaProductos(object):
    ...
    "border-radius: 27px;")
            ...
            #Boton revisar producto
            self.btnRevisarProd = QtWidgets.QPushButton(self.frame)
            self.btnRevisarProd.setGeometry(QtCore.QRect(1014, 633, 231, 61))
            self.btnRevisarProd.setEnabled(False)
            font = QtGui.QFont()
            font.setFamily("Open Sans Semibold")
    ...
    "border-radius: 27px")
            ...
            self.labelUsuarip.setGeometry(QtCore.QRect(12, 10, 91, 91))
            font = QtGui.QFont()
            font.setFamily("Open Sans Semibold")
            font.setPointSize(22)
            font.setBold(True)
            ...
            self.labelUsuario2.setGeometry(QtCore.QRect(112, 30, 91, 51))
            font = QtGui.QFont()
            font.setFamily("Open Sans Semibold")
            ...
            self.labelUsuarioEnLogin.setGeometry(QtCore.QRect(202, 30, 161, 51))
            font = QtGui.QFont()
            font.setFamily("Open Sans Semibold")
            font.setPointSize(15)
            font.setBold(True)
            ...
            self.labelAtras.setGeometry(QtCore.QRect(40, 637, 71, 51))
            ...
            self.btnAtras.setGeometry(QtCore.QRect(40, 639, 70, 50))
        ...
        def cargarProductosCSV(self):
            ...
            if datos:
                    # Seleccionar las columnas "Id", "Nombre", "Categoria", "Marca", "Precio"}
                    datos_seleccionados = [[fila[2],fila[9] ,fila[0], fila[7], fila[4], fila[3] ,fila[5]] for fila in datos]
        ...
        def cambiar_ventanaVerificar(self, idProducto):
            self.uiVentanaActual = QtWidgets.QApplication.activeWindow()
            self.uiVentanaActual.close()
            self.nuevaVentana = QtWidgets.QMainWindow()
            self.ui = Ui_VerificarProd(idProducto)
            self.ui.setupUi(self.nuevaVentana)
            self.nuevaVentana.show()
        ...
        def actualizarBotones(self):
                ...
                if filasSeleccionada:
                        ...
                        self.btnRevisarProd.setEnabled(True)
                else:
                        # No se seleccionó ninguna fila
                        self.btnRevisarProd.setEnabled(False)

        def abrir_ventana_verificar_producto(self):
                filasSeleccionadas = self.listaProductos.selectedIndexes()
