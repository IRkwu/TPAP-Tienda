...
from uiVentEmer import uiVentEm
...
"border-radius: 27px")
        ...
        self.btnRevisarProd.clicked.connect(lambda:self.cambiar_ventana(uiVentEm))
    ...
    def cargarProductosCSV(self):
        ...
        if datos:
                # Seleccionar las columnas "Id", "Nombre", "Categoria", "Marca", "Precio" (columnas 0, 7 , 1 y 2) 
                datos_seleccionados = [[fila[2],fila[0] ,fila[7], fila[3], fila[4]] for fila in datos]
