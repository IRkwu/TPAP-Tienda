...
"border-radius: 27px;")
        ...
        self.btnRealizarVenta = QtWidgets.QPushButton(self.frame)
        self.btnRealizarVenta.setGeometry(QtCore.QRect(1014, 633, 205, 55))
        font = QtGui.QFont()
        font.setFamily("Open Sans Semibold")
        ...
        font.setWeight(75)
        self.btnRealizarVenta.setFont(font)
        self.btnRealizarVenta.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btnRealizarVenta.setStyleSheet("background-color: rgb(240, 240, 240);\n"
"border-radius: 27px")
        self.btnRealizarVenta.setObjectName("btnRealizarVenta")

        #Accion boton realizar venta
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnRealizarVenta.setText(_translate("MainWindow", "Realizar venta"))
