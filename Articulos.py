...
class Articulos:
    ...
    def GuardarCSV_Articulos(self, lista_articulos):
    ...
    def CargarCSV_Articulos(self, ruta_archivo):
        lista_articulos = []
    ...
    def MostrarListaArticulos(self):
        contador = 1
        for articulo in ListaArticulos:
            print("[Art:", contador, "]",
                  ...
                  articulo.get_stock(), "\n[Descripcion]:",
                  articulo.get_descripcion(
                  ), "[Categoría]:", articulo.get_categoria(),
...
ListaArticulos = Articulos.CargarCSV_Articulos(None,
