...
class Ui_VerificarProd(object):
        ...
        "border-radius: 16px;")
                ...
                self.botonAgregar.clicked.connect(lambda:self.cambiar_ventana(uiVentEm))
        ...
        def cambiar_ventana(self, nombreVentana):
            ...
            self.ui = nombreVentana(self.idProducto)
        ...
        def obtener_datos_usuario(self):
            with open('Archivos de Datos/ListaArticulos.csv', 'r') as file:
                reader = csv.reader(file)
                for row in reader:
                    if row[2] == self.idProducto:
                        self.labelNombre.setText(row[0])
                        self.labelNombre.setAlignment(QtCore.Qt.AlignCenter)  
                        self.labelMascota.setText(row[1])
                        self.labelMascota.setAlignment(QtCore.Qt.AlignCenter)  
                        self.labelid.setText(row[2])
                        self.labelid.setAlignment(QtCore.Qt.AlignCenter)  
                        self.labelMarca.setText(row[3])
                        self.labelMarca.setAlignment(QtCore.Qt.AlignCenter)  
                        self.labelPrecio.setText(row[4])
                        self.labelPrecio.setAlignment(QtCore.Qt.AlignCenter) 
                        self.labelStockEditable.setText(row[5])
                        self.labelStockEditable.setAlignment(QtCore.Qt.AlignCenter)   
                        self.labelCategoria.setText(row[7])
                        self.labelCategoria.setAlignment(QtCore.Qt.AlignCenter)  
                        self.labelPrecioLote.setText(row[8])
                        self.labelPrecioLote.setAlignment(QtCore.Qt.AlignCenter)  
                        break
