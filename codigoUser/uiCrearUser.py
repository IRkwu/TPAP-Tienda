...
"border-radius: 16px;")
        ...
        self.labelLogo.setPixmap(QtGui.QPixmap("TPAP-Tienda-AngeloMu-oz/imagenes/Icono Fondo.png"))
...
"background-color: rgb(255, 255, 255);")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("TPAP-Tienda-AngeloMu-oz/imagenes/Masculino.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxG.addItem(icon1, "")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("TPAP-Tienda-AngeloMu-oz/imagenes/Femenino.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxG.addItem(icon2, "")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("TPAP-Tienda-AngeloMu-oz/imagenes/Otro.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"background-color: rgb(255, 255, 255);")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("TPAP-Tienda-AngeloMu-oz/imagenes/Cajero.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxC.addItem(icon6, "")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("TPAP-Tienda-AngeloMu-oz/imagenes/Gerente.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxC.addItem(icon7, "")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("TPAP-Tienda-AngeloMu-oz/imagenes/Asistente.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
